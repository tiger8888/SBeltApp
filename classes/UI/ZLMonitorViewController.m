...
-(void)openToolBar{
    [UIView animateWithDuration:0.1 delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        bgView.frame = CGRectMake(0, 0,320, 460 - 64);
        container.frame = CGRectMake(0, 0,320, 460 - 64);
...
-(void)closeToolBar{
    [UIView animateWithDuration:0.1 delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        container.frame = CGRectMake(0, 0,320, 460);
    } completion:^(BOOL finished) {
...
- (void)viewDidLoad
{
    ...
    ZLScrollMenuView *scrollMenu = [[ZLScrollMenuView alloc] initWithFrame:CGRectMake(0, 460-64, 320, 64)];
    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:@"Browse-彩色.png"] withHighLightImage:[UIImage imageNamed:@"Browse-灰色.png"] withTitle:@"浏览" withTarget:self withSel:@selector(browseFunction)];
    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:@"Store-彩色.png"] withHighLightImage:[UIImage imageNamed:@"Store-灰色.png"] withTitle:@"存储" withTarget:self withSel:@selector(storageFunction)];
    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:@"Setting-彩色1.png"] withHighLightImage:[UIImage imageNamed:@"Setting-灰色1.png"] withTitle:@"设置" withTarget:self withSel:@selector(settingFunction)];
    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:@"Bluetooth-彩色.png"] withHighLightImage:[UIImage imageNamed:@"Bluetooth-灰色.png"] withTitle:@"连接" withTarget:self withSel:@selector(bluetoothFunction)];
    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:@"Freeze-彩色.png"] withHighLightImage:[UIImage imageNamed:@"Freeze-灰色.png"] withTitle:@"冻结" withTarget:self withSel:@selector(freezeFunction)];

    [scrollMenu addItemIntoMenuWithNormalImage:[UIImage imageNamed:nil] withHighLightImage:[UIImage imageNamed:nil] withTitle:@"Exit" withTarget:self withSel:@selector(exitFunction)];
    ...
    container = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, 460)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {//ECG
        ...
        ecgGainButton.center = CGPointMake(200, 20);
    ...
    if (indexPath.row == 1) {//Respiration
        ...
        respGainButton.center = CGPointMake(200, 20);
